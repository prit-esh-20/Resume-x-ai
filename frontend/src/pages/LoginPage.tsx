...
export function LoginPage() {
  ...
  return (
    <AuthShell
      ...
      aside={<AuthVisual className="hidden lg:block" />}
    >
      <motion.h1
        id="login-heading"
      ...
      <motion.p
        ...
        {...rise(0.25)}
      >
        Preview build — any email with an 8+ character password signs in. Use
        the password &ldquo;wrong&rdquo; to see the error state.
      </motion.p>
